$('#add_new_user_button').click(()=>{
    ...
    if(username.localeCompare("qotato") != 0 && username.localeCompare("jasminebrew") != 0 && username.localeCompare("ElegantDisaster") != 0 && username.localeCompare("Tyv") != 0 && username.localeCompare("Boxerme") != 0 ){
